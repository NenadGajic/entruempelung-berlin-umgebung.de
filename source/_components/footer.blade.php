        ...
        <div class="row">
            <div class="col-lg-4 col-sm-6">
                <div class="footer__one-widget">
                    <a class="logo" href="/"><img src="/assets/img/logo-w.png" alt="Entrümpelung Berlin Logo"></a>
                ...
                <div class="footer__one-widget contact ml-40 xl-ml-0">
                    ...
                    <div class="contact-item">
                        ...
                        <div class="contact-item-info">
                            <span>E-Mail</span>
                            <h6><a href="mailto:office@entruempelung-berlin-umgebung.de">office@entruempelung-berlin-umgebung.de</a></h6>
                        </div>
                    </div>

                    <div class="contact-item mt-20">
                        <div class="contact-item-icon">
